# Задание: Создать кнопки и клавиатуры для главного
#          меню и меню настроек.
#          Создать кастомный фильтр для кнопок.
#          Изменить хендлер команд start, time, help.
#          Добавить хендлер команды /settings и кнопки "Настройки".
